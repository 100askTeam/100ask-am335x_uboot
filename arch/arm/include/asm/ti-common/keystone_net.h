...
/* 10G */
#define KS2_XGESS_BASE			CONFIG_KSNET_NETCPX_BASE
...
#define DEVICE_CPSWX_NUM_PORTS		3
...
#define XGE_PCSR_OFFSET			0x600
#define XGE_PCSR_PORT_OFFSET(x)		(XGE_PCSR_OFFSET + (x * 0x80))
#define XGE_PCSR_PORT_RX_STATUS(x)	(XGE_PCSR_PORT_OFFSET(x) + 0xc)

/* Register values */
#define XGESS_REG_VAL_XGMII_MODE	0x3
#define XMACSL_RX_ENABLE_CSF		BIT(23)
#define XMACSL_XGMII_ENABLE		BIT(13)
#define XMACSL_XGIG_MODE		BIT(8)

#define CPSWX_REG_VAL_STAT_ENABLE_ALL	0x7

#define XGE_PCSR_BLOCK_LOCK_MASK	BIT(30)
#define XGE_PCSR_BLOCK_LOCK_SHIFT	30
