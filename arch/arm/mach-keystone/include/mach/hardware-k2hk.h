...
#define KS2_NETCP_PDMA_DEST_PORT_INFO	PKT_INFO

/* NETCP */
#define KS2_NETCP_BASE			0x02000000

/* 10gbe NETCP pktdma */
#define KS2_NETCPX_PDMA_RX_FREE_QUEUE	9029
#define KS2_NETCPX_PDMA_RX_RCV_QUEUE	9030
#define KS2_NETCPX_PDMA_TX_SND_QUEUE	8752
