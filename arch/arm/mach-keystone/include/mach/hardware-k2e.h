...
#define KS2_NETCP_PDMA_DEST_PORT_INFO	TAG_INFO

/* NETCP */
#define KS2_NETCP_BASE			0x24000000

/* 10gbe NETCP pktdma */
#define KS2_NETCPX_PDMA_RX_FREE_QUEUE	4001
#define KS2_NETCPX_PDMA_RX_RCV_QUEUE	4002
#define KS2_NETCPX_PDMA_TX_SND_QUEUE	692
