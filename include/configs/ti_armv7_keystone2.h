...
#define CONFIG_KSNAV_QM_LINK_RAM_SIZE		KS2_QM_LINK_RAM_SIZE
#define CONFIG_KSNAV_QM_REGION_NUM		KS2_QM_REGION_NUM
#define CONFIG_KSNAV_QM_QPOOL_NUM		KS2_QM_QPOOL_NUM
#define CONFIG_KSNAV_QM_QUEUES_PER_QMGR		KS2_QM_QUEUES_PER_QMGR
#define CONFIG_KSNAV_QM_START_QUEUE		0

#ifdef CONFIG_SOC_K2HK
#define CONFIG_KSNAV_QM2_QUEUE_STATUS_BASE	KS2_QM2_QUEUE_STATUS_BASE
#define CONFIG_KSNAV_QM2_MANAGER_QUEUES_BASE	KS2_QM2_MANAGER_QUEUES_BASE
#define CONFIG_KSNAV_QM2_BASE_ADDRESS		KS2_QM2_BASE_ADDRESS
#define CONFIG_KSNAV_QM2_LINK_RAM_BASE		KS2_QM2_LINK_RAM_BASE
#define CONFIG_KSNAV_QM2_MANAGER_Q_PROXY_BASE	KS2_QM2_MANAGER_Q_PROXY_BASE
#define CONFIG_KSNAV_QM2_STATUS_RAM_BASE	KS2_QM2_STATUS_RAM_BASE
#define CONFIG_KSNAV_QM2_CONF_BASE		KS2_QM2_CONF_BASE
#define CONFIG_KSNAV_QM2_INTD_CONF_BASE		KS2_QM2_INTD_CONF_BASE
#define CONFIG_KSNAV_QM2_DESC_SETUP_BASE	KS2_QM2_DESC_SETUP_BASE
#define CONFIG_KSNAV_QM2_REGION_NUM		KS2_QM2_REGION_NUM
#define CONFIG_KSNAV_QM2_PDSP1_CMD_BASE		KS2_QM2_PDSP1_CMD_BASE
#define CONFIG_KSNAV_QM2_PDSP1_CTRL_BASE	KS2_QM2_PDSP1_CTRL_BASE
#define CONFIG_KSNAV_QM2_PDSP1_IRAM_BASE	KS2_QM2_PDSP1_IRAM_BASE
#define CONFIG_KSNAV_QM2_LINK_RAM_SIZE		KS2_QM2_LINK_RAM_SIZE
#define CONFIG_KSNAV_QM2_QUEUES_PER_QMGR	KS2_QM2_QUEUES_PER_QMGR
#define CONFIG_KSNAV_QM2_QPOOL_NUM		KS2_QM2_QPOOL_NUM
#define CONFIG_KSNAV_QM2_START_QUEUE		8192
#endif

#define CONFIG_KSNAV_QM_QS_PER_LOGICAL_QM	KS2_QM_QS_PER_LOGICAL_QM
...
#define CONFIG_KSNAV_NETCP_PDMA_DEST_PORT_INFO	KS2_NETCP_PDMA_DEST_PORT_INFO

/* 10gbe NETCP pktdma */
#define CONFIG_KSNAV_NETCPX_PDMA_CTRL_BASE	KS2_NETCPX_PDMA_CTRL_BASE
#define CONFIG_KSNAV_NETCPX_PDMA_TX_BASE	KS2_NETCPX_PDMA_TX_BASE
#define CONFIG_KSNAV_NETCPX_PDMA_TX_CH_NUM	KS2_NETCPX_PDMA_TX_CH_NUM
#define CONFIG_KSNAV_NETCPX_PDMA_RX_BASE	KS2_NETCPX_PDMA_RX_BASE
#define CONFIG_KSNAV_NETCPX_PDMA_RX_CH_NUM	KS2_NETCPX_PDMA_RX_CH_NUM
#define CONFIG_KSNAV_NETCPX_PDMA_SCHED_BASE	KS2_NETCPX_PDMA_SCHED_BASE
#define CONFIG_KSNAV_NETCPX_PDMA_RX_FLOW_BASE	KS2_NETCPX_PDMA_RX_FLOW_BASE
#define CONFIG_KSNAV_NETCPX_PDMA_RX_FLOW_NUM	KS2_NETCPX_PDMA_RX_FLOW_NUM
#define CONFIG_KSNAV_NETCPX_PDMA_RX_FREE_QUEUE	KS2_NETCPX_PDMA_RX_FREE_QUEUE
#define CONFIG_KSNAV_NETCPX_PDMA_RX_RCV_QUEUE	KS2_NETCPX_PDMA_RX_RCV_QUEUE
#define CONFIG_KSNAV_NETCPX_PDMA_TX_SND_QUEUE	KS2_NETCPX_PDMA_TX_SND_QUEUE
#define CONFIG_KSNAV_NETCPX_PDMA_DEST_PORT_INFO	KS2_NETCPX_PDMA_DEST_PORT_INFO
...
#define CONFIG_KSNET_SERDES_LANES_PER_XGMII	KS2_LANES_PER_XGMII_SERDES
#define CONFIG_KSNET_SERDES_XGMII_BASE		KS2_XGMII_SERDES_BASE
#endif

/* Keystone 10gbe net */
#define CONFIG_KSNET_NETCPX_BASE		0x02f00000
